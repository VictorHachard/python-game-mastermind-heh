...
start_btn = pygame.image.load(os.path.join("game_assets", "button_UI.png")).convert_alpha()
logo = pygame.image.load(os.path.join("game_assets", "button_UI.png")).convert_alpha()
