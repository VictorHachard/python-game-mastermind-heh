...
class WinMenu(object):
    ...
    def new(self):
        ...
        self.winMenu = Menu(self.screen, self.main, 6).addText('Win', 60).addText('Special unlock', 50).addText('').addText('').addText('')
    ...
    def draw(self):
        ...
        self.screen.blit(self.main.bottle[self.difficultyLvl], (300, 250))
        self.winMenu.render()
